...
const ProductInfo = ({product: {basePrice, totalPrice, description, name, discountPercentage}, 
}: ProductInfoProps) => {
        ...
        <div className="flex flex-col px-5 ">
            ...
            {discountPercentage > 0 && (
                <p className="text-sm opacity-75 line-through">
                    R$ {Number(basePrice).toFixed(2)}</p>
                )}
            ...
            <div className="flex flex-col gap-3 mt-8">
                ...
                <p className="opacity-60 text-justify" >{description}</p>
            </div>
